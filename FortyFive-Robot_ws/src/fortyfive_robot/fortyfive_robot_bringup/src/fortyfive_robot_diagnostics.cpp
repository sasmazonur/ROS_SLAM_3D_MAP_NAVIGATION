...
#include <fortyfive_robot_msgs/SensorState.h>
#include <fortyfive_robot_msgs/VersionInfo.h>
#include <string>
...
void sensorStateMsgCallback(const fortyfive_robot_msgs::SensorState::ConstPtr &msg)
{
  if (msg->battery > 11.0)
  ...
  if (msg->button == fortyfive_robot_msgs::SensorState::BUTTON0)
    setButtonDiagnosis(diagnostic_msgs::DiagnosticStatus::OK, "BUTTON 0 IS PUSHED");
  else if (msg->button == fortyfive_robot_msgs::SensorState::BUTTON1)
...
void firmwareVersionMsgCallback(const fortyfive_robot_msgs::VersionInfo::ConstPtr &msg)
{
  ...
  fortyfive_robot_msgs::VersionInfo version;
...
{
  ros::init(argc, argv, "fortyfive_robot_diagnostic");
  ros::NodeHandle nh;

  tb3_diagnostics_pub  = nh.advertise<diagnostic_msgs::DiagnosticArray>("diagnostics", 10);
  tb3_version_info_pub = nh.advertise<fortyfive_robot_msgs::VersionInfo>("version_info", 10);
